...
def build_sam_vit_h(checkpoint=None, image_size = 512, args= None):
    return _build_sam(
        args = args,
...
def build_sam_vit_l(checkpoint=None,image_size = 512,args= None):
    return _build_sam(
        args=args,
...
def build_sam_vit_b(checkpoint=None,image_size = 512,args= None):
    return _build_sam(
        args=args,
...
def _build_sam(
    ...
    if checkpoint is not None:
        ...
        local_checkpoint = os.path.join(this_dir, checkpoint)
        if not os.path.isabs(checkpoint) and os.path.exists(local_checkpoint):
            checkpoint = local_checkpoint
        print("====================Load Pretrained SAM Weights====================")
